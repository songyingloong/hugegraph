...
public class VertexCoreTest extends BaseCoreTest {
    ...
    @Test
    public void testQueryByLabelAndPageWithLimitLtePageSize() {
        Assume.assumeTrue("Not support paging",
                          storeFeatures().supportsQueryByPage());
    ...
    @Test
    public void testQueryByLabelAndPageWithLimitGtPageSize() {
        Assume.assumeTrue("Not support paging",
                          storeFeatures().supportsQueryByPage());
    ...
    @Test
    public void testQueryBySingleLabelAndPage() {
        Assume.assumeTrue("Not support paging",
                          storeFeatures().supportsQueryByPage());
    ...
    @Test
    public void testQueryByMultiLabelAndPage() {
        Assume.assumeTrue("Not support paging",
                storeFeatures().supportsQueryByPage());
    ...
    @Test
    public void testQueryByPropertyAndPageWithLimitLtePageSize() {
        Assume.assumeTrue("Not support paging",
                          storeFeatures().supportsQueryByPage());
    ...
    @Test
    public void testQueryByPropertyAndPageWithLimitGtPageSize() {
        Assume.assumeTrue("Not support paging",
                          storeFeatures().supportsQueryByPage());
    ...
    @Test
    public void testQueryBySingleSecondaryPropertyAndPage() {
        Assume.assumeTrue("Not support paging",
                          storeFeatures().supportsQueryByPage());
    ...
    @Test
    public void testQueryBySingleRangePropertyAndPage() {
        Assume.assumeTrue("Not support paging",
                          storeFeatures().supportsQueryByPage());
    ...
    @Test
    public void testQueryBySingleSearchPropertyAndPage() {
        Assume.assumeTrue("Not support paging",
                          storeFeatures().supportsQueryByPage());
    ...
    @Test
    public void testQueryByCompositePropertyAndPage() {
        Assume.assumeTrue("Not support paging",
                          storeFeatures().supportsQueryByPage());
        ...
        vertices = g.V().has("name", "marko").has("age", 30)
                    .has("~page", page).limit(40).toList();
        Assert.assertEquals(17, vertices.size());
        Vertex vertex4 = vertices.get(10);
        Assert.assertEquals(vertex3.id(), vertex4.id());
        Assert.assertEquals(vertex3.label(), vertex4.label());
        Assert.assertEquals(IteratorUtils.asList(vertex3.properties()),
                            IteratorUtils.asList(vertex4.properties()));
    ...
    @Test
    public void testQueryByJointPropertyAndPage() {
        Assume.assumeTrue("Not support paging",
                          storeFeatures().supportsQueryByPage());
    ...
    // TODO: Add some union index query test
